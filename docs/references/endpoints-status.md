...
Última atualização: 2026-09-01 — `routes/api.php`, `routes/web.php`, `docs/mvp-beta-checklist.md`, PRs #55 (comentários), #61 (domínio rico), #64 (CRUD clientes API).
...
| API — Projetos (arquivos + anotações) | 7 | 0 | 7 ⬜ |
