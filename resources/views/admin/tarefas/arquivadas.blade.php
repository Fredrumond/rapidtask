			...
			<table class="table">
				...
				<tbody>
					...
					<tr class="text-center tarefa-arquivada">
						...
						<td>							
							<button class="btn btn-success restaurar-tarefa" data-id="{{$tarefa->id}}">Restaurar</button>
							<button class="btn btn-danger excluir-tarefa" data-id="{{$tarefa->id}}">Excluir</button>
						</td>								
					</tr>
					@endforeach
